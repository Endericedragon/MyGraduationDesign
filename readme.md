...
### Q: 为什么在api.query.balances.account中查不到账户余额？

账户余额存储在api.query.system.account里。

关于如何切换存储余额的位置，请参考[这个issue](https://github.com/paritytech/subport/issues/118)和[它的后续](https://stackoverflow.com/questions/66511734/how-do-we-use-the-balances-pallet-instead-of-the-system-pallet-to-store-the-bala/66512980)。
